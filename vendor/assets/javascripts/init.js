				...
				// Skel.
					skel.init({
						...
						breakpoints: {
							...
							desktop: { range: '737-', href: 'assets/style-desktop.css', viewport: { width: 1280, scalable: false } },
							mobile: { range: '-736', href: 'assets/style-mobile.css', viewport: { scalable: false } }
						}
					});
